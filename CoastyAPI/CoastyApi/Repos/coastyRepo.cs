        ...
        public async Task<object> GetAvgWaterLevels(WaterLvlRequest request)
        {
            ...
            try
            {
                ...
                using (var command = connection.CreateCommand())
                {
                    ...
                    command.Parameters.Add(new MySqlParameter("p_start_date", 
                        string.IsNullOrEmpty(request.startDate) ? DBNull.Value : request.startDate));
                    command.Parameters.Add(new MySqlParameter("p_end_date", 
                        string.IsNullOrEmpty(request.endDate) ? DBNull.Value : request.endDate));
